  ...
  return (
    <Section className="py-32 md:py-44 relative">
      <div className="max-w-5xl mx-auto text-center relative z-10">
        <Reveal>
          <div className="inline-flex items-center gap-3 px-6 py-2 rounded-full museum-plaque text-[#C5A059] text-xs md:text-sm font-bold uppercase mb-8 shadow-md">
            <span>الرؤية</span>
          </div>
        </Reveal>
        ...
        <div className="relative p-10 md:p-20 rounded-[40px] bg-white border border-[#C5A059]/30 museum-frame-shadow">
          ...
          <Reveal delay={0.25}>
            <p className="max-w-3xl mx-auto text-lg md:text-2xl leading-10 text-neutral-700 font-serif">
              ...
              بل هو الأسلوب الشخصي في التفكير وقدرة العين على صياغة الشكل والمعنى.
              <br />
              <span className="block mt-4 text-[#A30018] font-bold">
                صُممت مناهجنا لتجمع بين المعرفة الأكاديمية والتطبيق العملي، لبناء شخصية فنية مستقلة ومبدعة.
              </span>
            </p>
          </Reveal>
        </div>
