            ...
            <div className="max-w-4xl mx-auto text-center">
              <Reveal>
                ...
                <p className="mt-10 text-xl leading-10 text-neutral-600">
                  نؤمن في الأكاديمية بأن الفن ليس مجرد أداة أو تقنية عابرة، بل هو لغة فكرية متكاملة وأسلوب في صياغة المعنى الرصين والجمالي. تم تصمبم مناهجنا لتبني الشخصية الفنية المستقلة لكل متدرب.
                </p>
              </Reveal>
